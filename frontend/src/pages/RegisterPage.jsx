    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      ...
      <div className="lg:flex-1 lg:w-2/3 relative bg-gradient-to-br from-primary/80 to-secondary/80">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center text-white h-full p-8 lg:p-16">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 drop-shadow-lg">Welcome to Gentle Stitch</h1>
          <p className="text-base md:text-lg lg:text-xl max-w-md lg:max-w-lg mb-6">
            Join our community of handmade crochet lovers. Create an account to start exploring unique, handcrafted pieces.
          </p>
      ...
      <div className="lg:w-1/3 flex items-center justify-center p-6 md:p-10 bg-white">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-center mb-6 hidden lg:block">Create Account</h1>

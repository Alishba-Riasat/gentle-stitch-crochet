...
const AboutUsPage = () => {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 md:px-6 lg:px-10 py-12 max-w-5xl text-center">
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 lg:px-10 py-12 max-w-5xl">
      <h1 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-6" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>About {storeName}</h1>
      <div className="border-t border-gray-200 mb-8"></div>

      <div className="space-y-8">
        <section>
          <h2 className="text-2xl font-semibold text-primary mb-3" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>Our Story</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-primary mb-3" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>Our Mission</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-primary mb-3" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>Why Choose Us?</h2>
        ...
        <section className="bg-gray-50 p-6 rounded-2xl">
          <h2 className="text-2xl font-semibold text-primary mb-3" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>Our Promise</h2>
          <p className="text-gray-600 leading-relaxed">
